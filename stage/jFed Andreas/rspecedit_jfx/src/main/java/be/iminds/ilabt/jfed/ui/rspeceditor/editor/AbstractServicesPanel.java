...
public abstract class AbstractServicesPanel<T> extends BorderPane implements Initializable {
...
//                   executeServices.remove(service);
    ...
    public AbstractServicesPanel() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AbstractServicesPanel.fxml"));
