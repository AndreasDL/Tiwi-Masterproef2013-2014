...
/**
 * TestAggregateManager3ListResources
 */
public class TestAggregateManager3ListResources extends ApiTest {
...
//    }
    ...
    public Object[][] getTypeVersionList() {
        ...
        int i = 0;
        for (AggregateManager3.VersionInfo.RspecVersion rspecVersion : versionInfo.getAdRspecVersions()) {
