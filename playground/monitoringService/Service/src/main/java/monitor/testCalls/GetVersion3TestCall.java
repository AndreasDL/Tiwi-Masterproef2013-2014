...
public class GetVersion3TestCall extends AutomatedTesterTestCall {
    ...
    public GetVersion3TestCall(ResultUploader resultUploader, TestInstance test, TestDefinition testDefinition, HashMap<String, Testbed> testbeds, Properties prop, boolean isLoadTest) {
