...
\input{Abstract-nl}                            % ...in het Nederlands en...
\input{Abstract-en}                            % ...in het Engels.
%voorwoord?
%dankwoord?/back	
...
\input{Situering} %kader FIRE SFA FED4FIRE GENI
\input{SFA-arch}%begrippen en stuffz
\input{Analyse}%FIRE monitor probleemstelling & GENI monitor
\input{Opbouw}%opbouw & vereisten
\input{Techno}%technologieën die gebruikt kunnen worden php <=> jsf/jsp
\input{Uitwerking} 
%use cases?
%\input{OntwerpService}
%\input{OntwerpDatabank}
%\input{Keuzes}
%werking
%besluit
