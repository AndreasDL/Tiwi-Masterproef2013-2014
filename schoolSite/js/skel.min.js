...
var skel = function() {
    var a = {config: {prefix: null, preloadStyleSheets: !1, pollOnce: !1, resetCSS: !1, normalizeCSS: !1, boxModel: null, useOrientation: !1, useRTL: !1, pollOnLock: !1, usePerpetualLock: !0, useDomainLock: !0, containers: 960, grid: {collapse: !1, gutters: 40}, breakpoints: {all: {range: "*", hasStyleSheet: !1}}, events: {}}, isConfigured: !1, isInit: !1, lockState: null, stateId: "", me: null, breakpoints: [], breakpointList: [], events: [], plugins: {}, cache: {elements: {}, states: {}}, locations: {html: null, head: null, body: null}, vars: {}, lsc: "_skel_lock",
        ...
        presets: {"default": {}, standard: {breakpoints: {mobile: {range: "-480", lockViewport: !0, containers: "fluid", grid: {collapse: 1, gutters: 10}}, desktop: {range: "481-", containers: 1200}, "1000px": {range: "481-1200", containers: 960}}}}, defaults: {breakpoint: {test: null, config: null, elements: null}, config_breakpoint: {range: "", containers: 960, lockViewport: !1, viewportWidth: !1, hasStyleSheet: !0, grid: {}}}, DOMReady: null, getElementsByClassName: null, indexOf: null, iterate: null, extend: function(b, d) {
            ...
            if ("ios" == a.vars.deviceType || "mac" == a.vars.deviceType || "windows" == a.vars.deviceType || "android" == a.vars.deviceType && b.match(/Safari\/([0-9]+)/) && 537 <= parseInt(RegExp.$1))
                return 1;
            if (void 0 !== window.devicePixelRatio && !b.match(/(Firefox; Mobile)/))
            ...
            if (window.matchMedia) {
                if (window.matchMedia("(-webkit-min-device-pixel-ratio: 2),(min--moz-device-pixel-ratio: 2),(-o-min-device-pixel-ratio: 2/1),(min-resolution: 2dppx)").matches)
                    return 2;
                if (window.matchMedia("(-webkit-min-device-pixel-ratio: 1.5),(min--moz-device-pixel-ratio: 1.5),(-o-min-device-pixel-ratio: 3/2),(min-resolution: 1.5dppx)").matches)
                    return 1.5
            }
            return 1
        }, getLevel: function(a) {
        ...
        isActive: function(b) {
            ...
            return a.cache.elements[b] = {id: b, object: d, location: c, priority: e}
        ...
        detachAllElements: function() {
            ...
            a.iterate(a.cache.elements, function(d) {
                ...
                if (b.parentNode && (!b.parentNode || b.parentNode.tagName) && (b.parentNode.removeChild(b), a.cache.elements[d].onDetach))
                    a.cache.elements[d].onDetach()
            })
            ...
            0 < c.length && a.DOMReady(function() {
                a.iterate(c, function(b) {
                    if (e = a.locations[c[b].location])
                        if (e._skel_attach(c[b].object), c[b].onAttach)
                            c[b].onAttach()
                })
            })
        }, poll: function() {
            ...
            var b, d = [], c = a.stateId.substring(1).split(a.sd);
        ...
        newDiv: function(a) {
            ...
            (function() {
                var b = window, d = function(a) {
                    ...
                    a = !1;
                    if (!e)
                        if (e = !0, "loading" !== c.readyState && h(), c.addEventListener)
            ...
            a.iterate = Object.keys ? function(a, d) {
                ...
                if (!a)
                    return[];
                for (var c in a)
                    Object.prototype.hasOwnProperty.call(a, c) && d(c)
            }
        }, initAPI: function() {
            var b, d, c = navigator.userAgent;
            a.vars.IEVersion = c.match(/MSIE ([0-9]+)\./) ? RegExp.$1 : 99;
            a.vars.deviceType = "other";
            d = {ios: "(iPad|iPhone|iPod)", android: "Android", mac: "Macintosh", wp: "Windows Phone", windows: "Windows NT"};
            a.iterate(d,
                    function(b) {
            ...
            if (window._skel_config)
                a.isConfigured = !0;
            else if (s = document.getElementsByTagName("script"), s = s[s.length - 1].innerHTML.replace(/^\s+|\s+$/g, ""))
                a.isConfigured =
                        !0;
