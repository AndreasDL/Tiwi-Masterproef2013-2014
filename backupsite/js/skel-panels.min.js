...
skel.registerPlugin("panels", function() {
    var b = {config: {baseZIndex: 1E4, useTransform: !0, transformBreakpoints: null, speed: 250, panels: {}, overlays: {}}, cache: {panels: {}, overlays: {}, body: null, window: null, pageWrapper: null, defaultWrapper: null, fixedWrapper: null, activePanel: null}, eventType: "click", positions: {panels: {top: ["top", "left"], right: ["top", "right"], bottom: ["bottom", "left"], left: ["top", "left"]}, overlays: {"top-left": {top: 0, left: 0}, "top-right": {top: 0, right: 0}, top: {top: 0, left: "50%"}, "top-center": {top: 0, left: "50%"},
        ...
        defaults: {config: {panel: {breakpoints: "", position: null, style: null, size: "80%", html: "", resetScroll: !0, resetForms: !0, swipeToClose: !0}, overlay: {breakpoints: "", position: null, width: 0, height: 0, html: ""}}}, recalcW: function(b) {
            var c = parseInt(b);
            ...
            var c, d;
            c = e.get(0);
            var h = e.attr("data-action"), f = e.attr("data-args"), g, l;
            h && f && (f = f.split(","));
            switch (h) {
                case "togglePanel":
                case "panelToggle":
                    ...
                    c = function(c) {
                        ...
                        if (b.cache.activePanel)
                            return b.cache.activePanel._skel_panels_close(), !1;
                        jQuery(this);
                        c = b.cache.panels[f[0]];
                        c.is(":visible") ? c._skel_panels_close() : c._skel_panels_open()
                    };
                    "android" == b._.vars.deviceType || "wp" == b._.vars.deviceType ? e.bind("click", c) : e.bind(b.eventType, c);
                    break;
                case "navList":
                    g = jQuery("#" + f[0]);
                    c = g.find("a");
                    ...
                    c.each(function() {
                        var b = jQuery(this), c;
                        c = Math.max(0, b.parents("li").length - 1);
                        d.push('<a class="link depth-' +
                                c + '" href="' + b.attr("href") + '"><span class="indent-' + c + '"></span>' + b.text() + "</a>")
                    });
                    0 < d.length && e.html("<nav>" + d.join("") + "</nav>");
                ...
                case "moveElement":
                    ...
                    break;
                case "moveCell":
                    g = jQuery("#" + f[0]), l = jQuery("#" + f[1]), c._skel_panels_resume = function() {
                        jQuery('<div id="skel-panels-tmp-' + g.attr("id") + '" />').insertBefore(g);
                        e.append(g);
                        g.css("width", "auto");
                        l &&
            ...
            var c = e.config, d = jQuery(e.object), h;
            ...
            switch (e.type) {
                case "panel":
                    ...
                    d.find("a").css("-webkit-tap-highlight-color", "rgba(0,0,0,0)").bind("click.skel-panels", function(c) {
                        var d = jQuery(this);
                        if (b.cache.activePanel && !d.hasClass("skel-panels-ignore")) {
                            c.preventDefault();
                            c.stopPropagation();
                            var e = d.attr("href"), f = d.attr("target");
                            b.cache.activePanel._skel_panels_close();
                            d.hasClass("skel-panels-ignoreHref") || window.setTimeout(function() {
                                "_blank" == f && "wp" != b._.vars.deviceType ? window.open(e) : window.location.href = e
                            }, b.config.speed + 10)
                        }
                    });
                    "ios" == b._.vars.deviceType && d.find("input,select,textarea").focus(function(c) {
                        ...
                        window.setTimeout(function() {
                            var c = b.cache.window._skel_panels_scrollPos, g = b.cache.window.scrollTop() - c;
                    ...
                    switch (c.position) {
                        ...
                        case "bottom":
                            ...
                            b._.vars.isTouch ? d.css("overflow-y", "scroll").css("-ms-overflow-style", "-ms-autohiding-scrollbar").css("-webkit-overflow-scrolling", "touch").bind("touchstart", function(b) {
                                ...
                                var c = d.outerHeight(), e = d.get(0).scrollHeight - d.scrollTop();
                                if (0 == d.scrollTop() && 0 > b || e > c - 2 && e < c + 2 && 0 < b)
                                    return!1
                            ...
                            switch (c.style) {
                                default:
                                    d._skel_panels_open =
                                            function() {
                                                d._skel_panels_promote().scrollTop(0).css("left", "0px").css(c.position, "-" + b.recalcH(c.size) + "px").css("height", b.recalcH(c.size)).css("width", "100%").show();
                        ...
                        case "left":
                        case "right":
                            switch (f = "right" == c.position ? "-" : "", d.addClass("skel-panels-panel-" + c.position).data("skel-panels-panel-position", c.position).css("width", b.recalcW(c.size)).scrollTop(0), b._.vars.isTouch ? d.css("overflow-y", "scroll").css("-ms-overflow-style", "-ms-autohiding-scrollbar").css("-webkit-overflow-scrolling", "touch").bind("touchstart", function(b) {
                                    d._posY =
                                    ...
                                    b = d._posY - b.originalEvent.touches[0].pageY;
                                    var f = d.outerHeight(), h = d.get(0).scrollHeight - d.scrollTop();
                                    if (c.swipeToClose && 20 > b && -20 < b && ("left" == c.position && 50 < e || "right" == c.position && -50 > e))
                                        return d._skel_panels_close(), !1;
                                    if (0 == d.scrollTop() && 0 > b || h > f - 2 && h < f + 2 && 0 < b)
                                        return!1
                                }) : d.css("overflow-y", "auto"), c.style){default:
                                    d._skel_panels_open = function() {
                                        d._skel_panels_promote().scrollTop(0).css("top",
                                                "0px").css(c.position, "-" + b.recalcW(c.size) + "px").css("width", b.recalcW(c.size)).css("height", "100%").show();
                                        c.resetScroll && d.scrollTop(0);
                                        c.resetForms && d._skel_panels_resetForms();
                                        b.lockView("x");
                                        window.setTimeout(function() {
                    ...
                    break;
                case "overlay":
                    d.css("z-index", b.config.baseZIndex).css("position", "fixed").addClass("skel-panels-overlay"), d.css("width",
                            c.width).css("height", c.height), (h = b.positions.overlays[c.position]) || (c.position = "top-left", h = b.positions.overlays[c.position]), d.addClass("skel-panels-overlay-" + c.position).data("skel-panels-overlay-position", c.position), b._.iterate(h, function(e) {
                        d.css(e, h[e]);
            ...
            jQuery.fn._skel_panels_xcssProperty = function(b, d) {
            ...
            if (b.config.useTransform && 10 <= b._.vars.IEVersion &&
                    (!b.config.transformBreakpoints || b._.hasActive(b.config.transformBreakpoints.split(","))))
                ...
                jQuery.fn._skel_panels_translate = function(c, d) {
                    ...
                    c = parseInt(c);
                    d = parseInt(d);
                    0 != c ? (b.cache.body.css("overflow-x", "hidden"), b.cache.pageWrapper.css("width", b.cache.window.width())) : g = function() {
                        b.cache.body.css("overflow-x", "visible");
                    ...
                    for (h = 0; h < this.length; h++) {
                        var k = this[h], n = jQuery(k), m;
                        if (!e[k.id])
                            if (m = b.positions.overlays[n.data("skel-panels-overlay-position")])
                                e[k.id] =
                                        m;
                            else if (m = b.positions.panels[n.data("skel-panels-panel-position")])
                                for (e[k.id] = {}, f = 0; m[f]; f++)
                                    e[k.id][m[f]] = parseInt(n.css(m[f]));
                            else
                                m = n.position(), e[k.id] = {top: m.top, left: m.left};
                        a = {};
            ...
            b._.DOMReady(function() {
                ...
                b.cache.defaultWrapper.css("height", "100%");
                ...
                b._.registerLocation("skel_panels_pageWrapper",
                        b.cache.pageWrapper[0]);
                $("[autofocus]").focus()
            })
            ...
            if ("android" == b._.vars.deviceType && 4 > b._.vars.deviceVersion || "wp" == b._.vars.deviceType)
                b.config.useTransform = !1;
            b.initObjects();
