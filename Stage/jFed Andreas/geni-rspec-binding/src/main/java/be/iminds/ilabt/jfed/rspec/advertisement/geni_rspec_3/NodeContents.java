...
public class NodeContents {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "cloud", namespace = "http://www.geni.net/resources/rspec/3", type = Cloud.class),
        ...
        @XmlElementRef(name = "available", namespace = "http://www.geni.net/resources/rspec/3", type = JAXBElement.class),
