...
public class RSpecContents {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "node", namespace = "http://www.geni.net/resources/rspec/3", type = JAXBElement.class),
        @XmlElementRef(name = "external_ref", namespace = "http://www.geni.net/resources/rspec/3", type = JAXBElement.class),
        @XmlElementRef(name = "link", namespace = "http://www.geni.net/resources/rspec/3", type = JAXBElement.class),
        @XmlElementRef(name = "type_relation", namespace = "http://www.geni.net/resources/rspec/3", type = JAXBElement.class)
    })
